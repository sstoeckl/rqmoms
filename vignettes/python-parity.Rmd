...
if (!has_py) cat('<div class="alert alert-warning" role="alert"><b>Python parity is disabled.</b> Set <code>RQMOMS_BUILD_PY=1</code> and either <code>RETICULATE_PYTHON</code> or <code>RQMOMS_VENV</code>. ',
